        ...
        <g:each in="${DictionaryItem.findAllByDictionary_id(admin.Dictionary.findByCode("CHAD54C"))}" status="i"
            ...
            <tr>
                ...
                <%
                    ...
                    if (end_date && from_date) {
                        countReferrals = AdolescentAbuse.executeQuery("select id from AdolescentAbuse where type=:referralsListInstance and arrival_time between '" + from_date + "' and '" + end_date + "'  and chaid.distric=:districtInstance", [referralsListInstance: referralsListInstance, districtInstance: districtInstance]).size()

                    } else {
                        countReferrals = AdolescentAbuse.executeQuery("select id from AdolescentAbuse where type=:referralsListInstance and chaid.distric=:districtInstance", [referralsListInstance: referralsListInstance, districtInstance: districtInstance]).size()
                    ...
                    if (end_date && from_date) {
                        countReferralsMale = AdolescentAbuse.executeQuery("select id from AdolescentAbuse where adolescent.gender in ('me','Me') and chaid.distric=:districtInstance and type=:referralsListInstance and arrival_time between '" + from_date + "' and '" + end_date + "'  ", [referralsListInstance: referralsListInstance, districtInstance: districtInstance]).size()

                    } else {
                        countReferralsMale = AdolescentAbuse.executeQuery("select id from AdolescentAbuse where adolescent.gender in ('me','Me') and chaid.distric=:districtInstance and type=:referralsListInstance ", [referralsListInstance: referralsListInstance, districtInstance: districtInstance]).size()
